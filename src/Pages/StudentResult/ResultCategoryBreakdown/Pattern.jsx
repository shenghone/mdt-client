...
import { getStudent, getOrganizedData } from "../../../util";
...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Pattern";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("RP") && item.Answer === item.userAnswer) {
  ...
  // console.log(level1Graph())
  // console.log(level2Graph())
  // console.log(level3Graph())
          ...
          <div className="contentWrapper">
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">Relations: Patterns (RP)</div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={5} category={"RP."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={5} category={"RP."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={3} category={"RP."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
