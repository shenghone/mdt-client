...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Measurement";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("SM") && item.Answer === item.userAnswer) {
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">
                  Shapes and Space: Measurement (SM)
                </div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={6} category={"SM."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={5} category={"SM."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={4} category={"SM."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
