...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Equation";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("RE") && item.Answer === item.userAnswer) {
          ...
          <div className="contentWrapper">
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">Relations: Equations (RE)</div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={4} category={"RE."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={3} category={"RE."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={6} category={"RE."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
