...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Number";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("NN") && item.Answer === item.userAnswer) {
          ...
          <div className="contentWrapper">
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">Numbers: Number Sense (NN)</div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={16} category={"NN."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={7} category={"NN."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={7} category={"NN."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
