...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Operation";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("NO") && item.Answer === item.userAnswer) {
          ...
          <div className="contentWrapper">
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">Numbers: Operations (NO)</div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={11} category={"NO."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={20} category={"NO."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={8} category={"NO."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
