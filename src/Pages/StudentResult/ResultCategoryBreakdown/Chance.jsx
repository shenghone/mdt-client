...
import { Level1Info, Level2Info, Level3Info } from "./CategoryInfo/Chance";
...
export default ({ location }) => {
  ...
  function populateLevel(item) {
    if (item.Section_name.includes("PC") && item.Answer === item.userAnswer) {
            ...
            <div className="mainContainer">
              ...
              <div className="categoryContainer">
                <div className="categoryTitle">
                  Statistics and Probability: Chance and Uncertainty (PC)
                </div>
                ...
                <div className="categoryInfo">
                  <div className="level">
                    ...
                    {openLevel1 && <span>No questions for Level 1</span>}
                    <h3>Result:</h3>
                    {Level1.length !== 0 ? (
                      <CategoryTable data={Level1} max={0} category={"PC."} />
                    ) : Level2.length !== 0 ? (
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level2.length !== 0 ? (
                      <CategoryTable data={Level2} max={2} category={"PC."} />
                    ) : Level1.length !== 0 ? (
                      <div className="resultText">Level Not Achieved</div>
                    ) : Level3.length !== 0 ? (
                      <div className="resultText">Cleared in Pretest</div>
                  ...
                  <div className="level">
                    ...
                    <h3>Result:</h3>
                    {Level3.length !== 0 ? (
                      <CategoryTable data={Level3} max={2} category={"PC."} />
                    ) : (
                      <div className="resultText">Level Not Achieved</div>
                    )}
                  </div>
